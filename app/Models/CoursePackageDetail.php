...
class CoursePackageDetail extends Model
{
    ...
    protected $fillable = ['course_package_id', 'order', 'course_matrix_id', 'course_start_date', 'course_end_date', 'course_code', 'wk_duration', 'tuition_fee', 'material_fee', 'application_fee'];
