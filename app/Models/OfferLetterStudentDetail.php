...
class OfferLetterStudentDetail extends Model implements AuditableContract
{
    ...
    protected $fillable  = ['current_address','home_address','country','state_province','postcode','mobile','telephone','email_personal','country_birth','visa_no','passport_no','passport_exp_date','delivery_loc'];
