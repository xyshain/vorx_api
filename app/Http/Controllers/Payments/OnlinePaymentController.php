...
class OnlinePaymentController extends Controller
{
    ...
    public function getCus($student_id){
        ...
        $funded_student = FundedStudentCourse::with('student.party')->where('student_id',$student_id)->first();
        $funded_student_contact = FundedStudentCourse::where('student_id',$student_id)->first();
        // return $funded_student;
        if(isset($stripe_cus)){
            return $stripe_cus->customer_id;
        }else{
            $customer = Stripe::customers()->create([
                'name'=>$funded_student->student->party->name,
                'email'=>$funded_student_contact->email,
                'phone'=>$funded_student_contact->phone_mobile
            ]);
