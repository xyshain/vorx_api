...
class EnrolmentPCADomesticController extends Controller
{
    ...
    {
        //
        // dd('yooooooooo PCA Enrolment Form - DOMESTIC');
        ...
        return view('enrolment.pca.domestic.index');
    }
                                ...
                                'content' => [
                                    [
                                        ...
                                        '<ul>
                                            ...
                                            <li>Entry Requirements for Domectic Students Policy and
                                            procedure</li>
                        ...
                        'inputs' => [
                            [
                                ...
                                'content' => [
                                    ...
                                    [
                                        'type' => 'paragraph',
                                        'body' => 'Please be advised that the information collected from the students as part of the enrolment will be provided to the Department of Home Affairs and other State/Territory government agencies.',
                                    ],
                                ],
                                // 'col_size' => 12
                            ],
    ...
    public function show($process_id)
    {
        ...
        if ($ep) {
            ...
            return view('enrolment.pca.domestic.attachment-signature');
        }
        return abort(404);
    }
    ...
    public function finish(Request $request, $process_id)
    {
        ...
        if($ep){
            ...
            $pfd_url = url('pca/online-enrolment/domestic/pdf/' . $ep['process_id'] . '');
    ...
    public function student_attachment($process_id){
        ...
        try {
            ...
            $pdf_file = \PDF::loadView('enrolment.pca.domestic.enrolment-form-pdf', compact('ef', 'ep', 'matrix'))->setPaper(array(0, 0, 595, 842), 'portrait')->save($file_path.'/'. $hashFileName . '.pdf');
            ...
            if($file == null){
                ...
                if($file->linked == 1){
                    ...
                    $pdf_file = \PDF::loadView('enrolment.pca.domestic.enrolment-form-pdf', compact('ef', 'ep', 'matrix'))->setPaper(array(0, 0, 595, 842), 'portrait')->save($file_path_.'/'. $hashFileName . '.pdf');
                }   
            }
    ...
    public function generate_pdf($process_id)
    {
        ...
        return \PDF::loadView('enrolment.pca.domestic.enrolment-form-pdf', compact('ef', 'ep', 'matrix'))->setPaper(array(0, 0, 595, 842), 'portrait')->stream('enrolment_form');
