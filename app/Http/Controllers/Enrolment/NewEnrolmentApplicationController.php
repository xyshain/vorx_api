...
class NewEnrolmentApplicationController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($ep != null){
            ...
            if($ef['currently_in_australia'] === false){
                $studentContactDetails['currently_in_australia'] = false;
                $studentContactDetails['home_country_res_addr'] = $ef['home_country_res_addr'];
    
            }else{
                $studentContactDetails['currently_in_australia'] = true;
            }
    ...
    public function link(Request $request){
        $data = EnrolmentPack::where('process_id',$request->process_id)->first();
