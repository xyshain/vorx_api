...
class EnrolmentController extends Controller
{
                                        ...
                                        'body' => [
                                            ...
                                            'tbody' => [
                                                [
                                                    ...
                                                    '<p class="text-center">AUD 1,400.00</p>',
                                    ...
                                    [
                                        ...
                                        'body' => [
                                            ...
                                            'tbody' => [
                                                ...
                                                [
                                                    '<b>Account Name</p>',
                                                    'Community Education of Australia',
                                                ],
                                            ]
                                        ],
                                    ]
    ...
    public function store(Request $request)
    {
        ...
        if($request->inputs['currently_in_australia'] == false){
            // default address required value for overseas
            $address = [
                'addr_street_num' => 'not specified',
                'addre_street_name' => 'not specified',
                'addr_suburb' => [
                    "id" => 16743,
                    "value" => "OSPC - Not specified, OO"
                ],
            ];
            $inputs = array_merge($request->inputs, $address);
        }else{
            $address = [
                'home_country_res_addr' => 'not specified',
            ];
            $inputs = array_merge($request->inputs, $address);
        }
