  ...
  <div>
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
        <div class="form-group">
          <label for="student_type">Delivery Location</label>
          <select
            name="student_type"
            v-model="delivery_loc"
            id="student_type"
            class="form-control"
          >
            <option v-for="(type,index) in dlvr_loc" :key="type" :value="type">{{ index }}</option>
          </select>
        </div>
        </div>
      <div class="col-md-6">
...
export default {
  ...
  data() {
    return {
      ...
      agent: "",
      delivery_loc : '',
      dlvr_loc : window.slct_training_dlvr_loc,
