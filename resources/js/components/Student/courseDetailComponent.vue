  ...
  <div>
    ...
    <div class="btn-group float-right" v-if="this.course != null">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" @click="generate_coe()" target="_blank" v-if="app_settings.training_organisation_id === '6074'">
          <i class="far fa-address-card text-info"></i>&nbsp; Generate COE
        </a>
...
export default {
  ...
  methods: {
    ...
    generate_coe() {
      window.open(
        `/student/coe/${window.student}/${this.getValues.course_code}`,
        "_blank"
      );
    },
    ...
    getTimetable() {
      if (this.getValues.class && this.getValues.class != "0") {
        axios
          .get(
