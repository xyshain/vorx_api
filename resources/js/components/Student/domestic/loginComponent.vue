            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div v-if="errors['user.username'] !== 'undefined'" class="badge badge-danger">{{ errors['user.username'][0] }}</div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div v-if="errors['user.make_password'] !== 'undefined'" class="badge badge-danger">{{ errors['user.make_password'][0] }}</div>
                    </div>
                </div>
                <div class="col-md-6">
                        <div class="form-group">
