    ...
    edit(id) {
      axios({
        ...
        .then((res) => {
          ...
          this.$parent.$children[0].$children[0].training_dlvr_location.id = this.$parent.$children[0].deliveryLocList[i].id;
          this.$parent.$children[0].$children[0].training_dlvr_location.training_organisation_id = this.$parent.$children[0].deliveryLocList[i].training_organisation_id;
          this.$parent.$children[0].$children[0].training_dlvr_location.train_org_dlvr_loc_id = this.$parent.$children[0].deliveryLocList[i].train_org_dlvr_loc_id;
          this.$parent.$children[0].$children[0].training_dlvr_location.train_org_dlvr_loc_name = this.$parent.$children[0].deliveryLocList[i].train_org_dlvr_loc_name;
          // this.$parent.$children[0].$children[1].postcode_val = res.data.postcode_val;
          this.$parent.$children[0].$children[0].training_dlvr_location.postcode = res.data.delivery_location_info.postcode;
          this.$parent.$children[0].$children[0].training_dlvr_location.state_id = res.data.delivery_location_info.state_id;
          this.$parent.$children[0].$children[0].training_dlvr_location.addr_location = res.data.delivery_location_info.addr_location;
          this.$parent.$children[0].$children[0].training_dlvr_location.country_id = res.data.country_val;
