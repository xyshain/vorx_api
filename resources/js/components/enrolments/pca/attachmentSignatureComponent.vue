    ...
    <div class="card border-0 shadow-lg ">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6">
                    <span class="font-weight-bold h4 m-0 float-right"> International</span>
            ...
            <div>
                ...
                <div class="row px-4 pt-4">
                    ...
                    <div class="col-md-12">
                        ...
                        :manualUpload='true' 
                        :renamefilenameURL="'/online-enrolment/attachment/rename/'"></attachments>
                    </div>
                </div>
                <div :class="'horizontal-line-wrapper-'+app_color+' mb-2 col-md-12 '">
...
export default {
    ...
    methods: {
        back() {
            window.location.href = '/pca/online-enrolment/get/' + this.process_id;
        },
        undo() {
        ...
        saveForm() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post('/pca/online-enrolment/save-signature/' + process_id, {
        ...
        finishForm() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post('/pca/online-enrolment/finish/' + process_id, {
                            process_id: vm.process_id,
