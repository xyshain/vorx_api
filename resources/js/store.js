...
export default new Vuex.Store({
    state: {
        ...
        student_filter_fields: (sessionStorage.getItem('filter_fields')) !== null ? JSON.parse(sessionStorage.getItem('filter_fields')) : {
            from:null,
            to:null,
            student_type:'*',
            get_status:'*',
    ...
    getters: {
        ...
        student_filter_fields : (state) => state.student_filter_fields
    },
    actions: {
        ...
        addStudentFilterFields: async({commit},fields)=>{
            // console.log('wtffffffffff');
            commit('setFilterFields',fields);
            sessionStorage.setItem('filter_fields',JSON.stringify(fields));
        }
    },
    mutations: {
        setFilterFields:(state,data)=> state.student_filter_fields = data,
