	...
	<div>
		<div class="col-xs-12 no-padding position-relative">
			<div class="pdf-wrapper">
				<div style="padding-bottom: 0;  margin: 0 10px;">
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td width="20%">
								<div class="eti-logo">
									{{-- <img src="{{$logo_url}}" alt=""> --}}
									<span class="secondary-font-color px-16-font proximanova-bold text-right line-height-1point2">RTO - {{$com_setting->training_organisation_id}}</span>
								</div>
							</td>
							<td width="80%">
								<!-- <p class="primary-font-color px-12-font text-right line-height-1point2">Certificate 3 Guarantee Program</p> -->
								<p class="secondary-font-color px-16-font text-right proximanova-bold line-height-1point2">TRAINING PLAN</p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div style="padding-bottom: 10px;  margin: 0 10px;">
					<div class="content">
						<h1 style="margin: 0" class="section-header proximanova-bold primary-font-color px-12-font text-justify text-uppercase"></h1>
                        <br>
...
@foreach ($data['program_details'] as $key=>$item)
	<body class="exo2-regular position-relative">
		<div>
			<div class="col-xs-12 no-padding position-relative">
				<div class="pdf-wrapper">
					<div style="padding-bottom: 0px;  margin: 0 10px;">
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="20%">
									<div class="eti-logo">
					...
					<div style="padding-bottom: 10px;  margin: 0 10px;">
						<div class="content">
							...
							@endif
							<br>
							<p class="px-14-font text-justify line-height-1point2" style="padding-bottom:5px;"><span class="proximanova-bold primary-font-color">TRAINING SCHEDULE</span></p>
							<table class="table default-bordered-table" cellspacing="0" cellpadding="0" width="100%">
								<thead>
									<tr>
								...
								<tbody>
									...
									<tr>
										<td class="px-10-font"> {{ $details['code'] }} - {{ $details['name'] }} </td>
										<td class="px-10-font">{{ $details['start_date'] }}</td>
										<td class="px-10-font">{{ $details['end_date'] }}</td>
										<td class="px-10-font">{{ $details['assestment_method'] }}</td>
										<td class="px-10-font">{{ $details['actual_start'] }}</td>
										<td class="px-10-font">{{ $details['actual_end'] }}</td>
										<td class="px-10-font"> {{ $details['student_status'] }} </td>
										<td class="px-10-font"> {{ $details['assestment_status'] }}</td>
									</tr>
									@endforeach
								</tbody>
							</table>
